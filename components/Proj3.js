class Proj3 extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
        <div class="island-wrapper fade-up">
            <div class="island js-tilt" style="padding: 0; overflow: hidden; display: flex; align-items: flex-start; justify-content: flex-start; aspect-ratio: 4/5; position: relative;">
                <img src="assets/VANAR_Final.png" alt="VANAR" style="width: 100%; height: 100%; object-fit: cover; position: absolute; inset: 0; transform: translateZ(20px);">
                <div style="position: absolute; top: 0; left: 0; width: 100%; background: linear-gradient(to bottom, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.7) 60%, transparent 100%); padding: 2.5rem var(--space-lg) var(--space-xl); transform: translateZ(40px); box-sizing: border-box;">
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: var(--space-sm);">
                        <h2 style="margin: 0; font-family: 'Syne', sans-serif; font-size: 2rem; color: #fff;">VANAR</h2>
                        <span style="color: var(--accent-red); font-size: 0.8rem; letter-spacing: 0.1em;">CONCEPTUAL</span>
                    </div>
                    <p style="margin: 0; color: var(--text-muted); font-family: var(--font-mono); font-size: 0.9rem; line-height: 1.5; min-height: 3em;">Releasing Soon!</p>
                </div>
            </div>
        </div>
        `;
...
customElements.define('tech-proj-3', Proj3);
